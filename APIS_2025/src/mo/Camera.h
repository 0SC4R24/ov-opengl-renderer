...
public: // Getters & Setters
	...
	MO_ProjectionType_e getCameraType()
	{ return m_type; }
	...
	void setCameraType(MO_ProjectionType_e cameraType)
	{ m_type = cameraType; }

public: // Constructor
	Camera(MO_ProjectionType_e cameraType, glm::vec3 position, glm::vec3 up, glm::vec3 lookAt);
